    ...
    <section className="ticket">
      ...
      <footer>
        ...
        <div className="btn-container">
          ...
          and there's no emplyee ticket associated w the service ticket
          ...
          {/* if the logged in user is the employee who is assigned to that ticket
          and there is no dateCompleted
